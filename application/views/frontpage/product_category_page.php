			...
			<nav class="navbar navbar-expand-lg navbar-dark mdb-color lighten-3 mt-3 mb-5">
				...
				<div class="collapse navbar-collapse" id="category_menu">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item<?= $data['category_slug'] === $category['category_slug'] ? ' active' : '' ?>">
			...
			<nav class="d-flex justify-content-center wow fadeIn">
				<ul class="pagination pg-blue">
					<li class="page-item<?= $data['current_page'] === 1 ? ' disabled' : '' ?>">
						<a class="page-link" href="<?= $data['current_page'] > 1 ? base_url('product/category/'.$data['category_slug'].'?page=') . previous_page($data['current_page']) : 'javascript:void(0)' ?>" aria-label="Sebelumnya">
					...
					<li class="page-item<?= $i === $data['current_page'] ? ' active' : '' ?>">
						<a class="page-link" href="<?= base_url('product/category/'.$data['category_slug'].'?page=') . $i ?>"><?= $i ?></a>
					</li>
					<?php endfor; ?>
